                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded-md border border-cyan-500/50 bg-cyan-500/10 px-2 py-1 text-xs text-cyan-200"
                      >
                        Edit
                      </button>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={loading}
                        className="rounded-md border border-emerald-500/50 bg-emerald-500/10 px-2 py-1 text-xs text-emerald-200 disabled:opacity-60"
                      >
                        Save
                      </button>
                      <button
